...
import ProductsDetailsTab from "../SingleProducts/ProductsDetailsTab6";
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            <div className="product-details-desc">
              <h3>ÁO SƠ MI NGẮN TAY XANH CARO </h3>

              <div className="price">
                <span className="new-price">300.000 VNĐ</span>
                <span className="old-price">360.000 VNĐ</span>
              </div>
              <p>Chọn size</p>

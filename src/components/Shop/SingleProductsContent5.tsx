...
import ProductsDetailsTab from "../SingleProducts/ProductsDetailsTab5";
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            <div className="product-details-desc">
              <h3>ÁO SƠ MI NGẮN TAY TRẮNG SAO </h3>

              <div className="price">
                <span className="new-price">280.000 VNĐ</span>
